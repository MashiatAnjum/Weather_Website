...
<body style="background-color:#9cd4df;">
  ...
  <div class="container py-5 " style="background-color:#76a2b9;">

    <div class="row d-flex justify-content-center align-items-center h-100" style="color: #282828;">
      
        <div class="card mb-4 gradient-custom" style="border-radius: 25px;background-color: white;">
        ...
        <div class="card mb-4" style="border-radius: 25px; color:rgb(0, 0, 0);background-color: white;">
          <div class="card-body p-4">
